...
function Serializer(sim) {
  ...
  //  Object containing functions to deserialize objects
  //  Done like this to allow directly looking up the type given by a serialized
  //  object
...
Serializer.prototype.deserializeArray = function(array, server_time_diff) {
  var ret = [];
...
Serializer.prototype.deserializeObject = function(serial, server_time_diff) {
...
Serializer.prototype.deserializeShip = function(o) {
  if (o.uid == our_id) {
    return null;
  }
